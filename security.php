...
<body>
    ...
    <div class="container my-5 d-flex flex-row gap-5 fs-3 py-5">
        ...
        <p class="securText">เมื่อเครื่องเริ่มทำงานไม่ควรนำมือไปสัมผัสกับตัวฐานของชิ้นงานและตัวกัดและห้ามปิดตัวเครื่องกลางคัน จนกว่าจะสั่งหยุดการทำงาน หรือรอเครื่องดำเนินกระบวนการตามตัวแบบ (Modal) จนเสร็จ เพระอาจจะเกิดอุบัติเหตุ (Accident) กับตัวผู้ใช้ และทำให้เกิดระบบขัดข้องได้</p>
    </div>
    <!-- -----footer----------- -->
